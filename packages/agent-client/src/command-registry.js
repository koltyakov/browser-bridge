...
export const CLI_HELP_SECTIONS = Object.freeze([
  {
    ...
    lines: [
      ...
      'bbx install-mcp [client|all] [--local] [--profile full|minimal]    Write MCP config for codex|claude|cursor|copilot|opencode|antigravity|windsurf|agents',
      '  --profile minimal registers only browser_call, browser_batch, browser_status, browser_health, and browser_access (~27KB less tool schema per session).',
